...
use app\models\tables\ComplaintSearch;
...
//            ],
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Додати нову скаргу",
                    'content'=>'<span class="text-success">Create Complaint success</span>',
                    'footer'=> Html::button('Закрити',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Complaint model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Complaint model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
