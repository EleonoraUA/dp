...
use app\models\tables\SymptomSearch;
...
//            ],
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Додати новий симптом",
                    'content'=>'<span class="text-success">Create Symptom success</span>',
                    'footer'=> Html::button('Закрити',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Symptom model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Symptom model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
