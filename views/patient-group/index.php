...
/* @var $searchModel app\models\tables\PatientGroupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Patient Groups');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="patient-group-index col-md-11">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Створити нову групу','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список усіх груп',
