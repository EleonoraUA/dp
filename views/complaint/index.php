...
/* @var $searchModel app\models\tables\ComplaintSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'visit.complaints');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="complaint-index col-md-11">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Додати нову скаргу','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список скарг',
